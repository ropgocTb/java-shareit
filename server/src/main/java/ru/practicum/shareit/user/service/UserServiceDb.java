...
public class UserServiceDb implements UserService {
    ...
    public UserDto editUser(Long id, UserDto userDto) {
        ...
        User existingEmailUser = repository.findByEmailAndIdIsNot(addedUser.getEmail(), addedUser.getId());

        if (existingEmailUser != null)
            throw new AlreadyTakenException("Этот email уже занят другим пользователем");
